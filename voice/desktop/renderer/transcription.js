...
export class TranscriptionDisplay {
  ...
  showResponseText(text) {
    ...
    if (this._reducedMotion?.matches) {
      this._responseText.textContent = text;
      this._scheduleAutoClear();
      return;
    }
  ...
  clear() {
    ...
    this._contentClearTimer = setTimeout(() => {
  ...
  _cancelContentClear() {
    if (this._contentClearTimer !== null) {
      clearTimeout(this._contentClearTimer);
      this._contentClearTimer = null;
    }
  }
}
