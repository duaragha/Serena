...
async def restore_codex_archive(session_id, cwd, *, confirmed=False, binary=None, env=None,
    ...
    try:
        ...
        exact_thread(await rpc.request('thread/read', {'threadId': session_id, 'includeTurns': False}), 'archived_sessions')
        ...
        try:
            ...
            lease.release()
    return {'session_id': session_id, 'provider': 'codex', 'cwd': str(project), 'archived': False}
