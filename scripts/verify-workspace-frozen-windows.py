...
def _remove_directory(directory, *, attempts=100, delay=0.05):
    """Remove a retired Windows process cwd after transient handle release."""
...
def main():
    ...
    observations = []
    directory = Path(tempfile.mkdtemp(prefix="serena-frozen-gate-"))
    try:
